...
//        }
        ...
        func update(_ mapView: MKMapView, from newView: Carte, context: Context) {
            defer { view = newView }
...
//            }
        ...
        private func updateAnnotations(on mapView: MKMapView, from previousView: Carte?, to newView: Carte) {
        ...
        private func updateInformationVisibility(on mapView: MKMapView, from previousView: Carte?, to newView: Carte) {
        ...
        private func updateInteractionModes(on mapView: MKMapView, from previousView: Carte?, to newView: Carte) {
        ...
        private func updateRegion(on mapView: MKMapView, from previousView: Carte?, to newView: Carte, animated: Bool) {
